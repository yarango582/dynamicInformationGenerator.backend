...
export class migrations1626478160750 implements MigrationInterface {
    name = 'migrations1626478160750'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "db_client" ("id" SERIAL NOT NULL, "nombre" character varying NOT NULL, "tipoDb" character varying NOT NULL, "host" character varying NOT NULL, "contrasena" character varying NOT NULL, "usuario_remoto" character varying NOT NULL, "puerto" integer NOT NULL, "clientIdId" integer, CONSTRAINT "PK_0e061b6948cd8a965f80c6fb2ff" PRIMARY KEY ("id"))`);
